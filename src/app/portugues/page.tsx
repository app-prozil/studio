...
const easyQuestions: Question[] = [
  { sentence: 'O ___ é um animal.', options: ['gato', 'casa', 'sol'], answer: 'gato' },
  { sentence: 'Eu gosto de ___ maçã.', options: ['beber', 'comer', 'ler'], answer: 'comer' },
  { sentence: 'A bola é ___.', options: ['quadrada', 'azul', 'redonda'], answer: 'redonda' },
];

export default function PortugueseGamesPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full">
      <Card className="w-full max-w-3xl text-center">
        <CardHeader>
          <CardTitle className="text-4xl font-headline">Exercícios de Português</CardTitle>
          <CardDescription className="text-lg">
            Complete as frases e aprenda novas palavras.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {!difficulty ? (
            ...
            <div className="space-y-8">
              <div className="relative p-8 border-4 border-dashed rounded-lg border-accent">
                <p className="text-5xl font-bold">{currentQuestion.sentence.replace('___', '_____')}</p>
